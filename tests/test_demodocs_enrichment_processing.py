...
async def test_demodoc_enrichment_processing(async_client, doc_path):
    """
    Tests the processing of a single demo document with the standard pipeline and picture description.
    """
    ...
    payload = {
        ...
        "generation_config": json.dumps(
            {"max_new_tokens": 800, "do_sample": False, "torch_dtype": "bf16"}
        ),
        "ocr_engine": "easyocr",
        "do_ocr": "true",
        "to_formats": ["md", "json"],
